...
import com.bupt.ZigbeeResolution.common.ResolutionTask;
            ...
            if (ch == channel){
                if (byteA3 == 30) { // HeartBeatMessage
                    ...
                    */
                    ...
                    // 解析设备上报数据
                    CacheQueueService.execute(new ResolutionTask(body, gatewayName, deviceTokenRelationService, sceneService, gatewayGroupService, sceneRelationService, dataService));
